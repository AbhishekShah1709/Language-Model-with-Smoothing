...
fe = open("./dataset_split/euro_part_4", "r")
content_part_euro = fe.read()
fe.close()

f1 = open("./outputs/L1_4_train.txt", "w")
f2 = open("./outputs/L2_4_train.txt", "w")
...
fm = open("./dataset_split/med_part_4", "r")
content_part_med = fm.read()
fm.close()


f3 = open("./outputs/L3_4_train.txt", "w")
f4 = open("./outputs/L4_4_train.txt", "w")
