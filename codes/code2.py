...
fe = open("./dataset_split/euro_part_2", "r")
content_part_euro = fe.read()
fe.close()

f1 = open("./outputs/L1_2_train.txt", "w")
f2 = open("./outputs/L2_2_train.txt", "w")
...
fm = open("./dataset_split/med_part_2", "r")
content_part_med = fm.read()
fm.close()


f3 = open("./outputs/L3_2_train.txt", "w")
f4 = open("./outputs/L4_2_train.txt", "w")
